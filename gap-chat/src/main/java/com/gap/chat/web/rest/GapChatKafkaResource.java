...
import com.gap.chat.config.KafkaSseConsumer;
import com.gap.chat.config.KafkaSseProducer;
...
@RestController
@RequestMapping("/api/gap-chat-kafka")
public class GapChatKafkaResource {

    private final Logger log = LoggerFactory.getLogger(GapChatKafkaResource.class);
    ...
    public GapChatKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
